...
export const UserPage: FC<{
  ...
  const renderGroupSection = () => {
    if (isLoadingGroupInfo) {
      return (
        <div className="text-gray-500 border-t pt-4 mt-4">
          Loading group info...
        </div>
      );
    }
          ...
          <div className="pt-2">
            {isAdmin ? (
              <button
                ...
                className="text-red-600 border border-red-600 px-3 py-1 rounded text-xs hover:bg-red-50 disabled:opacity-50"
              >
        ...
        <div className="border-t pt-4 mt-4 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={isSubmitting}
              className="text-white bg-blue-600 px-3 py-1 rounded text-xs hover:bg-blue-700 disabled:opacity-50"
            >
              {isSubmitting ? '...' : 'Create'}
            </button>
          </div>
        ...
        <div className="border-t pt-4 mt-4 space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={isSubmitting}
              className="text-white bg-green-600 px-3 py-1 rounded text-xs hover:bg-green-700 disabled:opacity-50"
            >
              {isSubmitting ? '...' : 'Join'}
            </button>
          </div>
